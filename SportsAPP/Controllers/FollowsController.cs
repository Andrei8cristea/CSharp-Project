...
namespace SportsAPP.Controllers
{
    ...
    public class FollowsController : Controller
    {
        ...
        // Follow a public account or send request to private account
        [HttpPost]
        ...
        // POST: Follows/CancelRequest/userId
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: Follows/AcceptRequest/requestId
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: Follows/RejectRequest/requestId
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // View followers list for a user
        ...
        // View following list for a user
